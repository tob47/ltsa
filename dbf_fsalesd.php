...
// Path to dbase file
$db_path = "D:\GABUNG\DATA\FSALESD.dbf";

// Open dbase file
$dbh = dbase_open($db_path, 0)
or die("Error! Tidat Dapat Menemukan Data Gabung ND pada file '$db_path'.");
...
{
global $conn;
if (!$dbf = dbase_open ($dbf_file, 0)){ die("Tidak Dapat Menbuka $dbf_file untuk di import."); }
